...
Display( )
{
	...
	Pattern->SetUniformVariable("Fragment", FragmentShader);
	
	Pattern->SetUniformVariable("Vertex", VertexShader);

	Pattern->SetUniformVariable("uS0", 5.f);
	Pattern->SetUniformVariable("uT0", 5.f);
	Pattern->SetUniformVariable("uDs", 5.f);
	Pattern->SetUniformVariable("uDt", 5.f);
	Pattern->SetUniformVariable("uTime", Time);
	Pattern->SetUniformVariable("uColor", 1.f, 1.f, 0.f); // ColorR, ColorG, ColorB
...
InitGraphics( )
{
	...
	// create pattern and setup shader

	Pattern = new GLSLProgram();
	bool valid = Pattern->Create("pattern.vert", "pattern.frag");
	if (!valid) 
	{
		fprintf(stderr, "Pattern invalid");
	}
