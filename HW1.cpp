	...
	*/
	...
	glNewList( BoxList, GL_COMPILE );
		...
		glBegin(GL_TRIANGLE_STRIP);
			...
			int piece = 4;
			glColor3f(1., 0., 0.);
			for (i = 0; i <= 1 * n / piece; i++) 
			{	
				glVertex3f(0, 2.f, 0);
				glVertex3f(R * cos(2 * PI / n * i), 0.f, R * sin(2 * PI / n * i));
			}
			glColor3f(1., 1., 0.);
			for (i = 1 * n/piece; i <= 2 * n / piece; i++)
			{
				glVertex3f(0, 2.f, 0);
				glVertex3f(R * cos(2 * PI / n * i), 0.f, R * sin(2 * PI / n * i));
			}
			glColor3f(0., 1., 0.);
			for (i = 2 * n / piece; i <= 3 * n / piece; i++)
			{
				glVertex3f(0, 2.f, 0);
				glVertex3f(R * cos(2 * PI / n * i), 0.f, R * sin(2 * PI / n * i));
			}
			glColor3f(0., 0., 1.);
			for (i = 3 * n / piece; i <= 4 * n / piece; i++)
			{
				glVertex3f(0, 2.f, 0);
				glVertex3f(R * cos(2 * PI / n * i), 0.f, R * sin(2 * PI / n * i));
			}
			...
			for (i = 0; i <= n; i++)
			{ 
				glVertex3f(R / 2 * cos(2 * PI / n * i), 0.f, R / 2 * sin(2 * PI / n * i));
				glVertex3f(0, 0.f, 0);
			}
			glColor3f(1., 0., 1.);
			for (i = 0; i <= n; i++) 
