...
Display( )
{
    ...
    glPopMatrix();
    SetSpotLight( GL_LIGHT0, 10, 0, -10, -20, 0, 20, 1, 1, 1 );
    ...
    glutSolidSphere(1, 10, 10);
    glPopMatrix();
    SetPointLight( GL_LIGHT1, 10, 10, 20, 1, 1, 0 );
   
    
    // light2
	glPushMatrix();
    glDisable(GL_LIGHTING);
    glTranslatef(-10., 10., 10 * light_ani);
    glColor3f(0., 1., 1.);
    glutSolidSphere(1, 10, 10);
    glPopMatrix();
	SetPointLight(GL_LIGHT2, -10, 10, 10 * light_ani, 0, 1, 1);
